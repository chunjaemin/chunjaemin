...
![FSD](https://img.shields.io/badge/FSD-Feature--Sliced%20Design-111827?style=flat)

# Achievements

| 수상/경력 | 기관 | 날짜 |
| --- | --- | --- |
| SW공모전 학장상 *(2nd)* | 숭실대학교 소프트웨어학부 | 2025.08.18 |
| 2024-1학기 성적 우수 장학생 *(석차 5/122, 평점 4.42)* | 숭실대학교 소프트웨어학부 | 2024.06.25 |
| 교내 알고리즘 대회 SCON 동상 | 숭실대학교 | 2025.05.17 |
| 2025 ICPC Seoul Regional 예선 *(70th, 교내 35팀 중 4th)* | 숭실대학교 | 2025.10.11 |
| 2024 ICPC Seoul Regional 예선 *(110th, 교내 60팀 중 7th)* | 숭실대학교 | 2024.11.22 |
...
| 활동 | 내용 | 기간 |
| --- | --- | --- |
| A:SSU 프론트엔드 개발팀 | 숭실대학교 제휴 매칭 플랫폼 프론트엔드 개발 | 2026.02.15- |
| 캡스톤디자인2 *(팀장)* | AI 기반 식단 추천 서비스 프론트엔드 개발 (React Native) | 2026.02.01- |
| HACKY-TALKY 4기 해커톤 *(팀장)* | 상담 데이터 자동 기록 솔루션 프론트엔드 개발 | 2025.11.07–11.08 |
| 2025 UNICON 게임 개발 대회 | 강화학습 기반 AI 땅따먹기 게임 개발 | 2025.11.01 |
| 2025 사이드 임팩트 AI 트랙 | 청년 멘토링 플랫폼 1인 풀스택 개발 | 2025.09.25–10.23 |
| 캡스톤디자인 *(팀장)* | AI 기반 식단 추천 서비스 프론트엔드 개발 (React) | 2025.09.01–12.31 |
| UNITHON 교내 해커톤 *(팀장)* | 택시 공유 플랫폼 프론트엔드 개발 | 2025.08.15–08.18 |
| 숭실대학교 소프트웨어학부 SW 공모전 *(팀장)* | 알바 통합 관리 서비스 프론트엔드 개발 | 2025.07.01–08.20 |
